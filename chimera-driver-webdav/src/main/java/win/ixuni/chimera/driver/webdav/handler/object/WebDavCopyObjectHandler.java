 ...
 * WebDAV 复制对象处理器
 * <p>
 * Implemented via GET + PUT, not relying on WebDAV COPY method to ensure compatibility.
 */
public class WebDavCopyObjectHandler implements OperationHandler<CopyObjectOperation, S3Object> {
