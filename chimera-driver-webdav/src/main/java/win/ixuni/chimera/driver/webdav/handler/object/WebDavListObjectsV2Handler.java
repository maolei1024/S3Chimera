 ...
 */
public class WebDavListObjectsV2Handler implements OperationHandler<ListObjectsV2Operation, ListObjectsV2Result> {
    ...
    public Mono<ListObjectsV2Result> handle(ListObjectsV2Operation operation, DriverContext context) {
        ...
        return Mono.fromCallable(() -> {
            ...
            String nextContinuationToken = truncated && !contents.isEmpty()
