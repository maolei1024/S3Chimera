 ...
 */
public class WebDavUploadPartHandler implements OperationHandler<UploadPartOperation, UploadPart> {
                    ...
                    try {
                        ...
                        return operation.getContent()
                                ...
                                .then(Mono.fromCallable(() -> {
                                    ...
                                    state.getParts().put(partNumber, WebDavDriverContext.PartInfo.builder()
